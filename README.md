...
evidence-led step at a time, suggests refactorings where the change introduces
or worsens a code smell, and waits for the author to route every finding before
changing code. Decisions and progress are kept in a disposable,
